...
public class SpinnerAdapterFoodType extends BaseAdapter {
    private ArrayList<ProductTypeModel> list;
    private Context context;

    public SpinnerAdapterFoodType(Context context, ArrayList<ProductTypeModel> value) {
